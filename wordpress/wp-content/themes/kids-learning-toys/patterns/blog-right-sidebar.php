 ...
 * Slug: kids-learning-toys/blog-right-sidebar
 * Categories: kids-learning-toys, blog-right-sidebar
 */
?>
...
<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e('Sorry, no post exist...','kids-learning-toys'); ?></h3>
<!-- /wp:heading -->
...
<div class="wp-block-column sidebar-col" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"kids-learning-toys","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->