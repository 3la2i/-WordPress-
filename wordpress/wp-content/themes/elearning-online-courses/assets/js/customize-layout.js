...
(function( $ ) {
	wp.customize.bind( 'ready', function() {
		...
		function online_tutor_customizer_label( id, title ) {
			...
			if ( id === 'online_tutor_woocommerce_product_sale' || id === 'online_tutor_woocommerce_related_product_show_hide' || id === 'online_tutor_woo_product_border_radius') {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-online_tutor_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
			...
			if ( id === 'online_tutor_ticket_text' || id === 'elearning_online_courses_admission' || id === 'elearning_online_courses_research' || id === 'elearning_online_courses_faq' || id === 'elearning_online_courses_search_setting') {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-online_tutor_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
			...
			if ( id === 'online_tutor_show_hide_footer' || id === 'online_tutor_show_hide_copyright') {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-online_tutor_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
			...
			if ( id === 'online_tutor_single_post_thumb' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-online_tutor_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
			...
			if ( id === 'online_tutor_single_post_comment_title' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-online_tutor_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
			...
			if ( id === 'online_tutor_post_page_title' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-online_tutor_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
			...
			if ( id === 'online_tutor_single_page_title' ) {
				$( '#customize-control-'+ id ).before('<li class="tab-title customize-control">'+ title  +'</li>');
			} else {
				$( '#customize-control-online_tutor_options-'+ id ).before('<li class="tab-title customize-control">'+ title +'</li>');
			}
		...
		online_tutor_customizer_label( 'online_tutor_products_per_row','Woocommerce Settings');
		online_tutor_customizer_label( 'online_tutor_woocommerce_product_sale', 'Woocommerce Product Sale' );
		online_tutor_customizer_label( 'online_tutor_woo_product_border_radius', 'Woocommerce Product' );
		online_tutor_customizer_label( 'online_tutor_woocommerce_related_product_show_hide', 'Woocommerce Related Products' );
		...
		online_tutor_customizer_label( 'elearning_online_courses_admission', 'Addmission' );
		online_tutor_customizer_label( 'elearning_online_courses_research', 'Research' );
		online_tutor_customizer_label( 'elearning_online_courses_faq', 'FAQs' );
		online_tutor_customizer_label( 'elearning_online_courses_search_setting', 'Top Header Search' );
		...
		//Footer
		online_tutor_customizer_label( 'online_tutor_show_hide_footer', 'Footer' );
		online_tutor_customizer_label( 'online_tutor_show_hide_copyright', 'Copyright' );

		//Single Post Setting
		online_tutor_customizer_label( 'online_tutor_single_post_thumb', 'Single Post Setting' );
		online_tutor_customizer_label( 'online_tutor_single_post_comment_title', 'Single Post Comment' );

		// Post Setting
		online_tutor_customizer_label( 'online_tutor_post_page_title', 'Post Setting' );

		// Page Setting
		online_tutor_customizer_label( 'online_tutor_single_page_title', 'Page Setting' );
