...
if ( ! defined( 'ONLINE_TUTOR_URL' ) ) {
    define( 'ONLINE_TUTOR_URL', esc_url( 'https://www.themagnifico.net/products/online-courses-wordpress-theme', 'elearning-online-courses') );
}
...
define('ONLINE_TUTOR_LIVE_DEMO',__('https://demo.themagnifico.net/elearning-online-courses/','elearning-online-courses'));
}
if ( ! defined( 'ONLINE_TUTOR_GET_PREMIUM_PRO' ) ) {
define('ONLINE_TUTOR_GET_PREMIUM_PRO',__('https://www.themagnifico.net/products/online-courses-wordpress-theme','elearning-online-courses'));
}
if ( ! defined( 'ONLINE_TUTOR_PRO_DOC' ) ) {
define('ONLINE_TUTOR_PRO_DOC',__('https://demo.themagnifico.net/eard/wathiqa/elearning-online-courses-doc/','elearning-online-courses'));
}
...
define('ONLINE_TUTOR_FREE_DOC',__('https://demo.themagnifico.net/eard/wathiqa/elearning-online-courses-free-doc/','elearning-online-courses'));
}
...
function elearning_online_courses_customize_register($wp_customize){ 
    ...
    $wp_customize->add_setting('elearning_online_courses_search_setting', array(
        'default' => false,
        'sanitize_callback' => 'online_tutor_sanitize_checkbox'
    ));
    $wp_customize->add_control( new WP_Customize_Control($wp_customize,'elearning_online_courses_search_setting',array(
        'label'          => __( 'Enable Header Search', 'elearning-online-courses' ),
        'section'        => 'online_tutor_top_header',
        'settings'       => 'elearning_online_courses_search_setting',
        'type'           => 'checkbox',
    )));
...
function elearning_online_courses_remove_customize_register() {
    ...
    $wp_customize->remove_setting( 'online_tutor_sticky_header' );
    $wp_customize->remove_control( 'online_tutor_sticky_header' );

    $wp_customize->remove_setting( 'online_tutor_preloader_hide' );
    $wp_customize->remove_control( 'online_tutor_preloader_hide' );

    $wp_customize->remove_setting( 'online_tutor_preloader_bg_color' );
    $wp_customize->remove_control( 'online_tutor_preloader_bg_color' );

    $wp_customize->remove_setting( 'online_tutor_preloader_dot_1_color' );
    $wp_customize->remove_control( 'online_tutor_preloader_dot_1_color' );

    $wp_customize->remove_setting( 'online_tutor_preloader_dot_2_color' );
    $wp_customize->remove_control( 'online_tutor_preloader_dot_2_color' );
}
